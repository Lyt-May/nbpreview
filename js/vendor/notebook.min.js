(function()
{
    ...
    nb.Cell.prototype.render=function(ci)
    {
        ...
        if(this.type=='code')
        {
            st_hr.style.cssText = "width: 240%; left: -70%; position: absolute; top: -0.825em;"
            ed_hr.style.cssText = "width: 240%; left: -70%; position: absolute; bottom: -0.825em;"
        }
        else
        {
            st_hr.style.cssText = "right: 0; left: 0; position: absolute; top: -0.825em;"
            ed_hr.style.cssText = "right: 0; left: 0; position: absolute; bottom: -0.825em;"
        }
