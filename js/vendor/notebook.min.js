(function()
{
    ...
    nb.Input.prototype.render=function(ci)
    {
        ...
        raw.forEach(function(line,l_id)
        {
            ...
            label.className = "nb-code_line_label"
    ...
    nb.Cell.prototype.render=function(ci)
    {
        ...
        if(this.type=='code')
        {
            st_hr.style.cssText = "width: 168%; left: -68%; position: absolute; top: 0;height: 1px;color: #eeeeee;background-color: #eeeeee;"
            //ed_hr.style.cssText = "width: 240%; left: -70%; position: absolute; bottom: -0.325em;"
        }
        else
        {
            st_hr.style.cssText = "right: 0; left: 0; position: absolute; top: 0;height: 1px;color: #eeeeee;background-color: #eeeeee;"
